...
public class TaildirSourceConfigurationConstants {
	...
	/**
	 * Whether to skip the position to EOF in the case of files not written on
	 * the position file.
	 */
	...
	/**
	 * Interval time (ms) to write the last position of each file on the
	 * position file.
	 */
	...
	public static final String EXTENSION_MULTILINE_PATTERN_KEY = "multilinePattern";
	public static final String EXTENSION_PREFIX = "extension.";

	public static final String EXTENSION_TIMESTAMP_PATTERN_KEY = "timestampPattern";
}
